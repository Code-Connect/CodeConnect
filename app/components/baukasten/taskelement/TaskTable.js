...
class TaskTable extends Component {
    ...
    setUndefPreview(){
        this.state({
            current_title: "Task Preview",
            current_description: "could not find element :("
    ...
    setActiveElement(taskid){
        ...
        this.setState( {
            current_title: element.name,
            current_description : element.description,
            current_input: element.input,
            current_output: element.output,
            current_tags: element.tags
        })
    }
    ...
    render () {
        ...
        return (
            <div className="row" style={{ background: 'white'}}>
                ...
                <StickyContainer style={{height: '600'}}> 
                                    ...
                                    return (
                                        <div style={style}>
                                            ...
                                            <TaskPreview title={this.state.current_title}
                                                tags={this.state.current_tags} description={this.state.current_description} input={this.state.current_input} output={this.state.current_output}/></div>
                                    )
                                }
                            }
                        </Sticky>
