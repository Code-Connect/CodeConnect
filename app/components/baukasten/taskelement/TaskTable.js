...
class TaskTable extends Component {
  ...
  setActiveElement(task) {
    this.setState({current_title: task.title, current_description: task.description})
  }
              ...
              {({
                ...
                return (
                  <div style={style}>
                    ...
                    <TaskPreview title={this.state.current_title} description={this.state.current_description}/></div>
                )
              }
}
            </Sticky>
